...
@Module({
  imports: [
    TypeOrmModule.forFeature([User, RefreshTokenFamily, RefreshToken, OAuthIdentity]),
  ...
  providers: [AuthService, TokenService, PasswordService, OAuthService, JwtStrategy],
