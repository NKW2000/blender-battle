 ...
 *
 * Translucent fill with a 3px border that turns orange and warms its background
 * on focus. The colour shift is paired with a background change so focus is not
      ...
      <div className="flex flex-col gap-2">
        ...
        <input
          ...
          className={cn(
            ...
            'placeholder:text-[#6E67A0] focus:border-select focus:bg-select/10',
